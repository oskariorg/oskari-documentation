...
**For setting up an oskari instance from source code skip this section and move to** <a data-link-relative="true" href="Setup development environment.md">Setup development environment</a>
