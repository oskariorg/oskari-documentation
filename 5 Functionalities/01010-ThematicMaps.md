...
See [requirements](01011-ThematicMapsRequirements.md) for using the thematic maps functionality in Oskari application.

See instructions for [configuring](01012-ThematicMapsConfig.md) the thematic maps functionality.
