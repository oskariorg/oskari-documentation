...
- [Database migrations](00040-DatabaseMigrations.md) document
- Flyway documentation: https://flywaydb.org/
- The database migration is triggered in class `org.oskari.init.OskariInitializer` (under oskari-server/service-webapp).